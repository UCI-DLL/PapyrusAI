...
export const FolderComponent = (props: FolderProps) => {
    ...
    function rename() {
        ...
        if (props.isOrganizationFolder) {
            ...
            Put(postUpdateOrgFolder(props.folder.id), dataToSend).then(
                (res) => {
            ...
            Put(postUpdateUserFolder(props.folder.id), dataToSend).then(
                (res) => {
                    if (res.status && res.status < 300) {
                        setAlert({
                            message: "Folder renamed successfully",
    ...
    const getFolderTags = () => {
        const allTags = props.folder.prompts.flatMap(
            (prompt) => prompt.tags || []
        );
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you would like to promote this folder
                            into an organization folder along everything in it?
                            This will remove the folder from your personal
                            ownership and transfer it to the organization level.
                            Proceeding will allow all instructors to be able to
                            read and use contains in modules. All admins will be
                            able to edit this folder.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
            ...
            <Dialog open={openDemoteDialog} onOpenChange={setOpenDemoteDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you would like to demote this
                            organization folder into a personal user folder
                            along everything in it? This will remove the folder
                            from the organization ownership and transfer it to
                            the user level. Proceeding will only let you edit
                            the folder.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
